...
const Links = ({ className }: { className?: string }) => (
  <>
    <Link
      className={className}
      href="https://github.com/LunaProject-Discord/react-spring-bottom-sheet/blob/main/GET_STARTED.md#get-started"
    >
      Get started
    </Link>
    <Link
      className={className}
      href="https://github.com/LunaProject-Discord/react-spring-bottom-sheet"
    >
      GitHub
    </Link>
  </>
